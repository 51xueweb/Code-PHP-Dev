...
<td><a href="test_info_add.php"><input type="button" name="subadd" value="添加试题"></a></td>
<td><a href="test_info_addmany.php"><input type="button" name="subadd" value="批量导入试题"></a></td>
</tr></table>
<?php
	error_reporting(0);
	// 获取用户输入
	...
	if(isset($_POST['sub'])){
		...
		foreach($result3 as $row3){
			...
			echo "&nbsp;&nbsp;<a href='test_info_edit.php?edit=$row3[ktinfo_id]'>编辑</a>&nbsp;|&nbsp;<a href='teacher_delete.php?delete=$row3[ktinfo_id]'>删除</a><br/>";
