...
<article>
	...
	<div id="main">
		...
		// 输出所有图书信息
			...
			$pagesize=10;
			$showpage=5;
			$sql="SELECT * FROM `097_1` order by book_date LIMIT $pre,$pagesize";
			$stmt=$dbh->query($sql);
			...
			foreach($result as $row2){
				...
				echo "<td class='class_td'><a href='manage_book_edit.php?id=$row2[book_id]'>编辑</a>|<a href='manage_book_delete.php?id=$row2[book_id]'>删除</a></td>"; 
				echo "</tr>";
			}
			echo "</table>";
			echo "</div>";
			//获取数据总数
			$total_sql="SELECT * FROM `097_1`";
